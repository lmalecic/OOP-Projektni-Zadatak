...
{
    public partial class VisitorsRankedListForm : Form
    {
        ...
        private async void LoadList()
        {
            ...
            var visitorStats = await App.WorldCupRepository.GetVisitorLeaderboards(App.Config.Tournament, App.Config.FavoriteTeam);
            dataGridView1.DataSource = visitorStats;
        }
